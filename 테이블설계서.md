...
| MEM_ADDRESS      | VARCHAR2(100) | 회원 주소, 필수항목                                       |                         NOT NULL                          |
| BIRTHDAY         |     DATE      | 회원생년월일                                              |                                                           |
| MEM_PHONE        | VARCHAR2(20)  | 회원 휴대전화, 필수항목                                   |                         NOT NULL                          |
| NICKNAME         | VARCHAR2(30)  | 기본값 이메일 + 난수(100000 ~ 999999 의 난수) 자바로 처리 |                          UNIQUE                           |
...
| REV_ORIGINAL_IMG_NAME | VARCHAR2(100) | 이미지 원본 이름        |                       NOT NULL                        |
