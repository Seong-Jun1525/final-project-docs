...
| INQ_TYPE_CD    | VARCHAR2(20)  | 담당문의유형             | FOREIGN KEY (INQ_TYPE_CD) REFERENCES INQUIRY_CATEGORY_TB (INQ_CD), NOT NULL | ADMIN_INQTP_FK |
...
| CK_CHAT_CTG      | VARCHAR2(20) | DEFAULT ETC, 문의 카테고리                          |       CHECK (CK_CHAT_CTG IN ('RESERVE', 'ETC')), NOT NULL       | CROOM_CATEGORY_CK |
...
| ACCOM_TYPE_NO    |     NUMBER     | 숙소유형번호              | FOREIGN KEY (ACCOM_TYPE_NO) REFERENCES ACCOMMODATION_TYPE_TB (ACCOM_TYPE_SQ), NOT NULL | ACCOM_TPNO_FK |
