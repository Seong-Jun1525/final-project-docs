...
> 작성자 : [임성준](https://www.github.com/Seong-Jun1525), [윤석준](https://www.github.com/free3510877)
...
| MEM_NICK     | VARCHAR2(50)  | 자동 생성 로직으로 초기값 설정                         |                     UNIQUE, NOT NULL                      |
| MEM_LVL      |    NUMBER     | DEFAULT 0, 회원레벨                                    |                         NOT NULL                          |
| MEM_ST       | VARCHAR2(10)  | DEFAULT 'ACTIVE', 활성화-'ACTIVE', 비활성화-'INACTIVE' |                         NOT NULL                          |
...
| ACCOM_IMG_CHG_NAME | VARCHAR2(100) | DEFAULT 'assets/resources/upload/acc/', 이미지 경로 |                               NOT NULL                                |
...
| ROOM_CNT     |    NUMBER    | DEFAULT 1, 객실 수      |                               NOT NULL                                |
...
| ROOM_IMG_CHG_NAME | VARCHAR2(100) | DEFAULT 'assets/resources/upload/acc/', 이미지 경로 |                          NOT NULL                          |
...
| 컬럼명      | 데이터타입 | 설명                |                        제약조건                        |
| :---------- | :--------: | :------------------ | :----------------------------------------------------: |
| LOC_NO      |   NUMBER   | 지역번호            | FOREIGN KEY LOC_NO REFERENCES LOCATION_TB, PRIMARY KEY |
...
| REV_IMG_CHG_NAME | VARCHAR2(100) | DEFAULT 'assets/resources/upload/review/', 이미지 경로 |                          NOT NULL                          |
...
| 컬럼명     |  데이터타입   | 설명                    |                          제약조건                          |
| :--------- | :-----------: | :---------------------- | :--------------------------------------------------------: |
| LOG_NO     |    NUMBER     | 일지번호, 시퀀스 사용   |                        PRIMARY KEY                         |
...
| CK_CHAT_ST   | VARCHAR2(10) | DEFAULT ACTIVE, ACTIVE : 활성화, INACTIVE: 비활성화 |                           NOT NULL                            |
| REG_DT       |     DATE     | DEFAULT SYSDATE, 등록일                             |                           NOT NULL                            |
| MEM_NO       |    NUMBER    | 회원번호                                            |  FOREIGN KEY MEM_NO REFERENCES MEMBER_TB (MEM_SQ), NOT NULL   |
| ADMIN_NO     |    NUMBER    | 관리자 번호                                         | FOREIGN KEY ADMIN_NO REFERENCES ADMIN_TB (ADMIN_SQ), NOT NULL |
