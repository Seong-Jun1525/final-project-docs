...
| MEM_SOC_UID       | VARCHAR2(30)  | 사용자 식별 값(API에서 제공 UID)                       |                                                           |
| MEM_SOC_REF_TOKEN | VARCHAR2(30)  | 리프레쉬 토큰                                          |                          UNIQUE                           |
| MEM_SOC_PLATFORM  | VARCHAR2(30)  | DEFAULT 'NORMAL'                                       | CHECK(PLATFORM IN ('NORMAL'. 'KAKAO', 'GOOGLE', 'NAVER')) |
| BIRTHDAY          |     DATE      | 회원생년월일(보류)                                     |                                                           |
| MEM_NICKNAME      | VARCHAR2(30)  | 자동 생성 로직 구현                                    |                     UNIQUE, NOT NULL                      |
| MEM_STATUS        | VARCHAR2(10)  | DEFAULT 'ACTIVE'. 활성화-'ACTIVE', 비활성화-'INACTIVE' |                         NOT NULL                          |
| MEM_REG_DATE      |     DATE      | DEFAULT SYSDATE, 가입날짜                              |                         NOT NULL                          |
| UPDATED_DATE      |     DATE      | 정보수정 날짜                                          |                                                           |
| INACTIVE_DATE     |     DATE      | 비활성화 날짜                                          |                                                           |

<!-- ## SOCIAL_MEMBER

| 컬럼명           |  데이터타입   | 설명                                                   |                         제약조건                          |
| :--------------- | :-----------: | :----------------------------------------------------- | :-------------------------------------------------------: |
| SOC_MEM_ID       | VARCHAR2(30)  | 사용자 식별 값(API에서 제공 UID)                       |                        PRIMARY KEY                        |
| MEM_EMAIL        | VARCHAR2(100) | 회원이메일, 필수항목                                   |                     UNIQUE, NOT NULL                      |
| REFRESH_TOKEN    | VARCHAR2(30)  | 리프레쉬 토큰                                          |                          UNIQUE                           |
| PLATFORM         | VARCHAR2(30)  | DEFAULT 'NORMAL'                                       | CHECK(PLATFORM IN ('NORMAL'. 'KAKAO', 'GOOGLE', 'NAVER')) |
| NICKNAME         | VARCHAR2(30)  | 기본값 이메일                                          |                          UNIQUE                           |
| REG_DATE  |     DATE      | DEFAULT SYSDATE, 가입날짜                              |                         NOT NULL                          |
| UPDATED_DATE     |     DATE      | 정보수정 날짜                                          |                                                           |
...
> CONSTRAINT MEMBER_EXPERIENCE(MEM_EXP) PRIMARY KEY(MEM_NO, RES_CODE)
...
| 컬럼명                  |   데이터타입   | 설명                      |  제약조건   |
| :---------------------- | :------------: | :------------------------ | :---------: |
| ACCOM_NO                |     NUMBER     | 숙박업소번호, 시퀀스 사용 | PRIMARY KEY |
| ACCOM_NAME              |  VARCHAR2(50)  | 숙박업소명                |  NOT NULL   |
| ACCOM_DESCRIPTION       | VARCHAR2(4000) | 숙박업소 설명             |  NOT NULL   |
| ACCOM_LATITUDE          |     NUMBER     | 위도                      |  NOT NULL   |
| ACCOM_LONGITUDE         |     NUMBER     | 경도                      |  NOT NULL   |
| ACCOM_REG_DATE          |      DATE      | DEFAULT SYSDATE, 등록일   |  NOT NULL   |
| ACCOM_ADDRESS           | VARCHAR2(255)  | 주소                      |  NOT NULL   |
| ACCOM_PHONE             |  VARCHAR2(20)  | 전화번호                  |  NOT NULL   |
| PUBLIC_FACILITIES_INFO  | VARCHAR2(200)  | 공용편의시설정보          |             |
| IN_ROOM_FACILITIES_INFO | VARCHAR2(200)  | 객실 내 시설 정보         |             |
| ETC_FACILITIES_INFO     | VARCHAR2(200)  | 기타시설정보              |             |
| ACCOM_TYPE_NO           |     NUMBER     | 숙소유형번호              |  NOT NULL   |

### ACCOM_IMG 숙박업소 이미지 테이블

| 컬럼명                  |  데이터타입   | 설명                            |                        제약조건                         |
| :---------------------- | :-----------: | :------------------------------ | :-----------------------------------------------------: |
| ACCOM_IMG_NO            |    NUMBER     | 숙박업소이미지번호, 시퀀스 사용 |                       PRIMARY KEY                       |
| ACCOM_IMG_ORIGINAL_NAME | VARCHAR2(100) | 이미지 원본 이름                |                        NOT NULL                         |
| ACCOM_IMG_CHANGE_NAME   | VARCHAR2(100) | 이미지 경로                     |                        NOT NULL                         |
| ACCOM_IMG_REG_DATE      |     DATE      | DEFAULT SYSDATE, 등록일         |                        NOT NULL                         |
| ACCOM_NO                |    NUMBER     | 숙박업소번호                    | FOREIGN KEY ACCOM_NO REFERENCES ACCOMMODATION, NOT NULL |
...
| 컬럼명               |  데이터타입  | 설명                    |                        제약조건                         |
| :------------------- | :----------: | :---------------------- | :-----------------------------------------------------: |
| ROOM_NO              |    NUMBER    | 객실번호, 시퀀스 사용   |                       PRIMARY KEY                       |
| ROOM_NAME            | VARCHAR2(50) | 객실명                  |                        NOT NULL                         |
| ROOM_PRICE           |    NUMBER    | 객실가격                |                        NOT NULL                         |
| ROOM_CHECK_IN        | VARCHAR2(10) | 체크인 시간             |                        NOT NULL                         |
| ROOM_CHECK_OUT       | VARCHAR2(10) | 체크아웃 시간           |                        NOT NULL                         |
...
| ROOM_REG_DATE        |     DATE     | DEFAULT SYSDATE, 등록일 |                        NOT NULL                         |
| ACCOM_NO             |    NUMBER    | 숙박업소번호            | FOREIGN KEY ACCOM_NO REFERENCES ACCOMMODATION, NOT NULL |
...
| 컬럼명                 |  데이터타입   | 설명                        |                       제약조건                        |
| :--------------------- | :-----------: | :-------------------------- | :---------------------------------------------------: |
| ROOM_IMG_NO            |    NUMBER     | 객실이미지번호, 시퀀스 사용 |                      PRIMARY KEY                      |
| ROOM_IMG_ORIGINAL_NAME | VARCHAR2(100) | 이미지 원본 이름            |                       NOT NULL                        |
| ROOM_IMG_CHANGE_NAME   | VARCHAR2(100) | 이미지 경로                 |                       NOT NULL                        |
| ROOM_IMG_REG_DATE      |     DATE      | DEFAULT SYSDATE, 등록일     |                       NOT NULL                        |
| ROOM_NO                |    NUMBER     | 객실번호                    | FOREIGN KEY ACC_NO REFERENCES ACCOMMODATION, NOT NULL |
...
| 컬럼명       |  데이터타입  | 설명                      |  제약조건   |
| :----------- | :----------: | :------------------------ | :---------: |
| PUB_FAC_NO   |    NUMBER    | 편의시설번호, 시퀀스 사용 | PRIMARY KEY |
...
| 컬럼명           |  데이터타입  | 설명                        |  제약조건   |
| :--------------- | :----------: | :-------------------------- | :---------: |
| IN_ROOM_FAC_NO   |    NUMBER    | 객실내시설번호, 시퀀스 사용 | PRIMARY KEY |
...
| 컬럼명       |  데이터타입  | 설명                      |  제약조건   |
| :----------- | :----------: | :------------------------ | :---------: |
| ETC_FAC_NO   |    NUMBER    | 기타시설번호, 시퀀스 사용 | PRIMARY KEY |
...
| 컬럼명          |  데이터타입  | 설명                  |  제약조건   |
| :-------------- | :----------: | :-------------------- | :---------: |
| ACCOM_TYPE_NO   |    NUMBER    | 유형번호, 시퀀스 사용 | PRIMARY KEY |
...
| 컬럼명          |  데이터타입  | 설명                    |  제약조건   |
| :-------------- | :----------: | :---------------------- | :---------: |
| COUPON_NO       |    NUMBER    | 쿠폰번호, 시퀀스 사용   | PRIMARY KEY |
| COUPON_NAME     | VARCHAR2(20) | 쿠폰명                  |  NOT NULL   |
| COUPON_PRICE    |    NUMBER    | 쿠폰가격                |  NOT NULL   |
| COUPON_REG_DATE |     DATE     | DEFAULT SYSDATE, 등록일 |  NOT NULL   |
...
| 컬럼명             | 데이터타입 | 설명                            |                     제약조건                      |
| :----------------- | :--------: | :------------------------------ | :-----------------------------------------------: |
| COUPON_DETAIL_NO   |   NUMBER   | 쿠폰 내역 번호, 시퀀스 사용     |                    PRIMARY KEY                    |
...
> 데이터 컬럼. 추후 변경될 수 있음. 자세한 사항은 Boot Pay API 참조
...
| 컬럼명         |  데이터타입  | 설명                                   |                          제약조건                          |
| :------------- | :----------: | :------------------------------------- | :--------------------------------------------------------: |
| RES_CODE       | VARCHAR2(10) | 예약코드, 예약코드생성로직구현         |                        PRIMARY KEY                         |
...
## LOCATION_SEARCH 지역 검색 테이블

| 컬럼명        | 데이터타입 | 설명           |                     제약조건                     |
| :------------ | :--------: | :------------- | :----------------------------------------------: |
| LOC_SEO_NO    |   NUMBER   | 지역 검색 번호 |                   PRIMARY KEY                    |
| LOC_SEO_COUNT |   NUMBER   | 검색횟수       |                     NOT NULL                     |
| LOC_NO        |   NUMBER   | 지역번호       | FOREIGN KEY LOC_NO REFERENCES LOCATION, NOT NULL |
...
| CART_REG_DATE |    DATE    | DEFAULT SYSDATE, 장바구니등록날짜 |                    NOT NULL                    |
| ROOM_NO       |   NUMBER   | 객실번호                          | FOREIGN KEY ROOM_NO REFERENCES ROOM, NOT NULL  |
| MEM_NO        |   NUMBER   | 회원번호                          | FOREIGN KEY MEM_NO REFERENCES MEMBER, NOT NULL |
...
| REV_REG_DATE |     DATE      | DEFAULT SYSDATE, 등록일 |                        NOT NULL                         |
...
### REVIEW_IMG 객실 이미지 테이블

| 컬럼명                |  데이터타입   | 설명                    |                    제약조건                    |
| :-------------------- | :-----------: | :---------------------- | :--------------------------------------------: |
| REV_IMG_NO            |    NUMBER     | 이용후기 이미지번호     |                  PRIMARY KEY                   |
| REV_IMG_ORIGINAL_NAME | VARCHAR2(100) | 이미지 원본 이름        |                    NOT NULL                    |
| REV_IMG_CHANGE_NAME   | VARCHAR2(100) | 이미지 경로             |                    NOT NULL                    |
| REV_IMG_REG_DATE      |     DATE      | DEFAULT SYSDATE, 등록일 |                    NOT NULL                    |
| REV_NO                |    NUMBER     | 이용후기 번호           | FOREIGN KEY REV_NO REFERENCES REVIEW, NOT NULL |
...
| DAY_LOG_REG_DATE |     DATE      | DEFAULT SYSDATE, 등록일 |                    NOT NULL                    |
| MEM_NO           |    NUMBER     | 회원번호                | FOREIGN KEY MEM_NO REFERENCES MEMBER, NOT NULL |
...
| ADMIN_EMAIL    | VARCHAR2(100) | 관리자 이메일           | UNIQUE, NOT NULL |
| REG_DATE       |     DATE      | DEFAULT SYSDATE, 등록일 |     NOT NULL     |
...
| CHAT_ROOM_CATEGORY | VARCHAR2(20)  | 문의 카테고리. '기타문의', '예약문의' 중 1 | CHECK (CHAT_CATEGORY IN ('RESERVE', 'ETC')), NOT NULL |
| REG_DATE           |     DATE      | DEFAULT SYSDATE, 등록일                    |                       NOT NULL                        |
...
| 컬럼명           |   데이터타입   | 설명                       |                        제약조건                         |
| :--------------- | :------------: | :------------------------- | :-----------------------------------------------------: |
| CHAT_MSG_NO      |     NUMBER     | 메시지번호                 |                       PRIMARY KEY                       |
| CHAT_MSG_CONTENT | VARCHAR2(1000) | 채팅메시지                 |                        NOT NULL                         |
| SEND_DATE        |      DATE      | DEFAULT SYSDATE, 보낸 날짜 |                        NOT NULL                         |
