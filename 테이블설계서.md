...
| ACC_DESCRIPTION             | VARCHAR2(4000) | 숙박업소 설명           |  NOT NULL   |
| ACC_LATITUDE                |     NUMBER     | 위도                    |  NOT NULL   |
| ACC_LONGITUDE               |     NUMBER     | 경도                    |  NOT NULL   |
| REGISTERED_DATE             |      DATE      | DEFAULT SYSDATE, 등록일 |  NOT NULL   |
| ACC_ADDRESS                 | VARCHAR2(255)  | 주소                    |  NOT NULL   |
| ACC_PHONE                   |  VARCHAR2(20)  | 전화번호                |  NOT NULL   |
| ACC_PUBLIC_FACILITIES_INFO  | VARCHAR2(200)  | 공용편의시설정보        |             |
| ACC_IN_ROOM_FACILITIES_INFO | VARCHAR2(200)  | 객실 내 시설 정보       |             |
| ACC_ETC_FACILITIES_INFO     | VARCHAR2(200)  | 기타시설정보            |             |
| ACC_TYPE_NO                 |     NUMBER     | 숙소유형번호            |  NOT NULL   |

### ACC_IMG 숙박업소 이미지 테이블

| 컬럼명                |  데이터타입   | 설명               |                       제약조건                        |
| :-------------------- | :-----------: | :----------------- | :---------------------------------------------------: |
| ACC_IMG_NO            |    NUMBER     | 숙박업소이미지번호 |                      PRIMARY KEY                      |
| ACC_IMG_ORIGINAL_NAME | VARCHAR2(100) | 이미지 원본 이름   |                       NOT NULL                        |
| ACC_IMG_CHANGE_NAME   | VARCHAR2(100) | 이미지 경로        |                       NOT NULL                        |
