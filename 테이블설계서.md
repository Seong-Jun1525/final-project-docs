...
| 컬럼명        | 데이터타입 | 설명                       |                       제약조건                        |
| :------------ | :--------: | :------------------------- | :---------------------------------------------------: |
| MEM_NO        |   NUMBER   | 회원번호, 시퀀스 사용      |    FOREIGN KEY MEM_NO REFERENCES MEMBER, NOT NULL     |
...
| 컬럼명                  |   데이터타입   | 설명                    |  제약조건   |
| :---------------------- | :------------: | :---------------------- | :---------: |
| ACCOM_NO                |     NUMBER     | 숙박업소번호            | PRIMARY KEY |
...
| 컬럼명                  |  데이터타입   | 설명               |                        제약조건                         |
| :---------------------- | :-----------: | :----------------- | :-----------------------------------------------------: |
| ACCOM_IMG_NO            |    NUMBER     | 숙박업소이미지번호 |                       PRIMARY KEY                       |
...
| 컬럼명                 |  데이터타입   | 설명             |                       제약조건                        |
| :--------------------- | :-----------: | :--------------- | :---------------------------------------------------: |
| ROOM_IMG_NO            |    NUMBER     | 객실이미지번호   |                      PRIMARY KEY                      |
...
| 컬럼명          |  데이터타입  | 설명         |  제약조건   |
| :-------------- | :----------: | :----------- | :---------: |
| ACCOM_TYPE_NO   |    NUMBER    | 유형번호     | PRIMARY KEY |
...
| CHAT_MSG_CONTENT   | VARCHAR2(255) | 채팅메시지                 |                        NOT NULL                         |
| CHAT_MSG_SEND_DATE |     DATE      | DEFAULT SYSDATE, 보낸 날짜 |                        NOT NULL                         |
| CHAT_ROOM_NO       |    NUMBER     | 채팅방번호                 | FOREIGN KEY CHAT_ROOM_NO REFERENCES CHAT_ROOM, NOT NULL |
| SENDER_EMAIL       |    NUMBER     | 메시지 보낸 사용자 이메일  |                        NOT NULL                         |
| ADMIN_NO           |    NUMBER     | 담당 관리자 번호           |     FOREIGN KEY ADMIN_NO REFERENCES ADMIN, NOT NULL     |
